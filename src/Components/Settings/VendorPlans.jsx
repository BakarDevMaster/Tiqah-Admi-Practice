...
const VendorPlans = () => {
  ...
  return (
    <div>
      <h3 className="text-xl font-medium mb-4">Vendor Plans</h3>
      <table className="min-w-full bg-white border border-gray-200 mb-4">
        <thead>
          <tr>
            ...
            <th className="py-2 px-4 border-b">Products Allowed</th>
        ...
        <tbody>
          {plans.map((plan, index) => (
            <tr key={index} className="text-center">
              ...
              <td className="py-2 px-4 border-b">{plan.productsAllowed}</td>
        ...
        <form onSubmit={handleAddPlan} className="mt-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input
                type="number"
                value={newPlan.productsAllowed}
                onChange={(e) =>
                  setNewPlan({ ...newPlan, productsAllowed: e.target.value })
                }
                required
                className="w-full border border-gray-300 rounded-md p-2"
              />
